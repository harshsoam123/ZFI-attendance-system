...
function placeholderAvatar() {
  return "data:image/svg+xml;utf8," + encodeURIComponent(
    `<svg xmlns='http://www.w3.org/2000/svg' width='100' height='100'><rect width='100' height='100' fill='#eaf0ff'/><text x='50' y='58' font-size='36' text-anchor='middle' fill='#1e5eff' font-family='Arial'>${(employee.fullName || "?").charAt(0)}</text></svg>`
  );
}
